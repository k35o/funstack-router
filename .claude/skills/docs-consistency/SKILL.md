...
description: Ensure consistency of documentation files. Used when you made a significant change to the codebase that may affect the documentation, or when you made a significant change to the documentation itself.
---
